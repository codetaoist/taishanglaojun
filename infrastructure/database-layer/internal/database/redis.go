...
type RedisConfig struct {
	...
	PoolTimeout          time.Duration        // 连接池超�?
	IdleTimeout          time.Duration        // 空闲连接超时
	IdleCheckFrequency   time.Duration        // 空闲连接检查频�?
	MaxConnAge           time.Duration        // 连接最大生存时�?
