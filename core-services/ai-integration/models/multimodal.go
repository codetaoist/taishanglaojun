...
// MultimodalType 多模态交互类型
type MultimodalType string

const (
	MultimodalTypeChat        MultimodalType = "chat"        // 多模态对话
	MultimodalTypeAnalysis    MultimodalType = "analysis"    // 多模态分析
	MultimodalTypeGeneration  MultimodalType = "generation"  // 多模态生成
	MultimodalTypeTranslation MultimodalType = "translation" // 多模态翻译
	MultimodalTypeSearch      MultimodalType = "search"      // 多模态搜索
)
...
type InputMetadata struct {
	...
	Duration   float64           `json:"duration,omitempty"` // 音频/视频时长(秒)
