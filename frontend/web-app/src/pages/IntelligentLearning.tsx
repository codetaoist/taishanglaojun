...
const IntelligentLearning: React.FC = () => {
  ...
  const getProgressChartData = () => {
    return weeklyActivity.map(activity => ({
      date: dayjs(activity.date).format('MM-DD'),
      ...
      <Row gutter={[16, 16]} style={{ marginBottom: '24px' }}>
        <Col xs={24} sm={12} lg={8} xl={6}>
          <Card
            ...
            styles={{ body: { padding: '24px', display: 'flex', flexDirection: 'column', justifyContent: 'center' } }}
            onClick={() => navigate('/learning/learning-progress')}
          >
              ...
              <Timeline>
                {weeklyActivity.slice(0, 5).map((day, index) => (
                  ...
                  >
                    <div>
                      <Space>
                        <Text strong>{dayjs(day.date).format('MM月DD日')}</Text>
                      ...
                      title={
                        <div>
                          ...
                          <div style={{ fontSize: '12px', opacity: 0.8 }}>
                            获得时间: {dayjs(achievement.earnedAt).format('YYYY-MM-DD HH:mm')}
                          </div>
                        </div>
                      }
                      placement="top"
                    >
                      ...
                      >
                        ...
                        <div style={{ 
                          ...
                          {dayjs(achievement.earnedAt).format('MM-DD')}
                        </div>
                      </Card>
                    </Tooltip>
                  </Col>
