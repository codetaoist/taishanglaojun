...
// PluginController 插件控制�?type PluginController struct {
	pluginService *services.PluginService
}

// NewPluginController 创建新的插件控制�?func NewPluginController(pluginService *services.PluginService) *PluginController {
