...
// JaegerExporter Jaeger导出�?
type JaegerExporter struct {
	*BaseExporter
	endpoint string
}

// NewJaegerExporter 创建Jaeger导出�?
...
// ZipkinExporter Zipkin导出�?
type ZipkinExporter struct {
	*BaseExporter
	endpoint string
}

// NewZipkinExporter 创建Zipkin导出�?
