...
var (
	mockUsers = []User{
		{
			ID: "user1", Username: "alice", Email: "alice@example.com", Nickname: "爱丽丝",
			Avatar: "https://example.com/avatar1.jpg", Bio: "热爱分享的技术爱好者",
		...
		},
		{
			...
			Avatar: "https://example.com/avatar2.jpg", Bio: "程序员，喜欢探索新技术",
	...
	mockPosts = []Post{
		{
			ID: "post1", Title: "Go语言微服务架构实践", Content: "本文分享了在实际项目中使用Go语言构建微服务架构的经验和最佳实践...",
			AuthorID: "user1", AuthorName: "爱丽丝", CategoryID: "tech", Tags: []string{"Go", "微服务", "架构"},
		...
		{
			ID: "post2", Title: "前端性能优化技巧", Content: "分享一些实用的前端性能优化技巧，包括代码分割、懒加载、缓存策略等...",
		...
		{
			ID: "post3", Title: "数据库设计原则", Content: "良好的数据库设计是系统性能的基础，本文介绍了数据库设计的基本原则...",
			AuthorID: "user2", AuthorName: "鲍勃", CategoryID: "database", Tags: []string{"数据库", "设计", "SQL"},
	...
	mockComments = []Comment{
		...
		},
		{
			...
			Content: "微服务架构确实是个好方向，但也要注意复杂性管理", LikeCount: 8, Status: "approved",
			CreatedAt: time.Now().AddDate(0, 0, -1), UpdatedAt: time.Now().AddDate(0, 0, -1),
		},
		{
			ID: "comment3", PostID: "post2", ParentID: nil, AuthorID: "user1", AuthorName: "爱丽丝",
	...
	mockChatRooms = []ChatRoom{
		{
			ID: "room1", Name: "技术讨论", Description: "讨论各种技术话题", Type: "public",
			CreatorID: "user1", MemberCount: 25, MaxMembers: 100, IsPrivate: false,
			CreatedAt: time.Now().AddDate(0, 0, -10),
		},
		{
			ID: "room2", Name: "前端交流", Description: "前端开发经验分享", Type: "public",
...
func main() {
	...
	log.Println("社区服务 (Mock版本) 启动在端口 8085")
	r.Run(":8085")
}
...
func getOnlineUsers(c *gin.Context) {
	// 模拟在线用户
	onlineUsers := []gin.H{
		{"user_id": "user1", "username": "爱丽丝", "status": "online"},
