...
const (
	ProjectStatusPlanning   ProjectStatus = "planning"   // 规划中
...
const (
	ProjectPriorityLow      ProjectPriority = "low"      // 低优先级
	ProjectPriorityMedium   ProjectPriority = "medium"   // 中优先级
	ProjectPriorityHigh     ProjectPriority = "high"     // 高优先级
	ProjectPriorityCritical ProjectPriority = "critical" // 紧急
)
...
const (
	ProjectTypeDevelopment ProjectType = "development" // 开发项目
	ProjectTypeResearch    ProjectType = "research"    // 研究项目
	ProjectTypeMaintenance ProjectType = "maintenance" // 维护项目
	ProjectTypeInternal    ProjectType = "internal"    // 内部项目
	ProjectTypeClient      ProjectType = "client"      // 客户项目
)
...
type ProjectStatistics struct {
	...
	AverageTaskTime float64 `json:"average_task_time"` // 平均任务完成时间（小时）
}
...
// GetCompletedMilestoneCount 获取已完成里程碑数量
