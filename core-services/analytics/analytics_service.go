...
type AnalyticsService interface {
	...
	UpdateReport(ctx context.Context, req *UpdateReportRequest) (*UpdateReportResponse, error)
	DeleteReport(ctx context.Context, req *DeleteReportRequest) (*DeleteReportResponse, error)
	DownloadReport(ctx context.Context, req *DownloadReportRequest) (*DownloadReportResponse, error)
	...
	GetSystemStats(ctx context.Context, req *GetSystemStatsRequest) (*StatisticsResponse, error)
}
...
// ExportDataRequest 导出数据请求（别名）
type ExportDataRequest = DataExportRequest
...
// GetExportStatusRequest 获取导出状态请求（别名）
type GetExportStatusRequest = ExportStatusRequest
...
// CleanupDataRequest 清理数据请求（别名）
type CleanupDataRequest = DataCleanupRequest
...
// GetSystemStatsRequest 获取系统统计请求
