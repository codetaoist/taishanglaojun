...
// buildFilterFromQuery 从查询参数构建过滤条�?
...
// convertToWisdomSummaryPointers 转换为指针切�?
...
// @Accept json
// @Produce json
// @Param keyword query string false "关键�?
// @Param category query string false "分类"
// @Param school query string false "学派"
// @Param author query string false "作�?
