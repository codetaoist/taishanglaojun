...
type ConversationConfig struct {
	...
	Language        string        `json:"language"`
	Voice           string        `json:"voice"`
	EnableVAD       bool          `json:"enable_vad"`       // 语音活动检�?
	...
	MaxDuration     time.Duration `json:"max_duration"`     // 最大对话时�?
