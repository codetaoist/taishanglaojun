...
// QualityMetrics 已移�?shared_types.go

// RecommendationType 推荐类型
// RecommendationType 已移�?shared_types.go
...
// AdaptiveRecommendationSettings 类型定义已移�?shared_types.go，使�?RecommendationSettings
...
// AdaptivePersonalizationEngine 类型定义已移�?shared_types.go，使�?PersonalizationEngine
...
// AdaptiveRecommendationAlgorithm 类型定义已移�?shared_types.go
...
// 缓存相关结构�?
// AdaptiveCachedLearnerProfile 缓存类型定义已移�?shared_types.go

// 其他简化的结构体定�?
// PersonalizationRule 类型定义已移�?shared_types.go
...
// RecommendationFilter, RecommendationRankingConfig, RecommendationDiversityConfig 类型定义已移�?shared_types.go
// type AdaptationRule struct{}
// type AdaptationModel struct{}
// type AdaptationMetrics struct{}
// PersonalizationModel,. LearnerModel, PersonalizationRecord, PersonalizationMetrics 类型定义已移�?shared_types.go
