...
// DatabaseHandler 动态数量据库管理器处理器器
type DatabaseHandler struct {
	dynamicDB *database.DynamicDatabase
	logger    *zap.Logger
}

// NewDatabaseHandler 创建数量据库处理器器
...
// AddDatabaseRequest 添加数量据库请求结构体
...
// GetCurrentDatabase 获取当前数量据库配置结构体
...
// GetDatabaseStats 获取数量据库统计信息结构体
