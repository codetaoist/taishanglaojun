...
// MultimodalRecommendationConfig 多模态推荐配�?
...
// MultimodalRecommendationCache 多模态推荐缓�?
...
// MultimodalRecommendationMetrics 多模态推荐指�?
...
// MultimodalRecommendationRequest 多模态推荐请�?
...
// MultimodalRecommendationResponse 多模态推荐响�?
...
// NewMultimodalRecommendationService 创建多模态推荐服�?
...
// calculateSemanticSimilarity 计算语义相似�?
...
// buildMultimodalRecommendation 构建多模态推�?
...
func (s *MultimodalRecommendationService) getAllowedDifficultyLevels(maxDifficulty string, learner *entities.Learner) []string {
	return []string{"beginner", "intermediate"} // 简化实�?
}
...
func (s *MultimodalRecommendationService) generateLearningInsights(ctx context.Context, learner *entities.Learner, recommendations []*MultimodalRecommendation) *LearningInsights {
	return &LearningInsights{
		...
		OptimalStudyTime:    []string{"上午9-11�?, "下午2-4�?},
		RecommendedStrategy: "结合理论学习和实践练�?,
	}
}
