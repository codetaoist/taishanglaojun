...
// @Summary 重新发送验证邮�?
// @Description 重新发送邮箱验证链�?
// @Tags 认证
// @Accept json
// @Produce json
// @Param request body models.ResendVerificationRequest true "重新发送验证请�?
