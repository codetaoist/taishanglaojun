...
// GetLearnerPaths 获取学习者的所有学习路径
// @Summary 获取学习者的学习路径列表
// @Description 获取指定学习者的所有学习路径列表
// @Tags learning-paths
// @Produce json
// @Param learner_id path string true "学习者ID"
// @Param status query string false "路径状态过滤" Enums(active, completed, paused)
