...
const (
	...
	CollaborativeFiltering        RecommendationStrategy = "collaborative_filtering" // 别名
	ContentBasedStrategy          RecommendationStrategy = "content_based"
	ContentBased                  RecommendationStrategy = "content_based" // 别名
	HybridStrategy               RecommendationStrategy = "hybrid"
	HybridApproach               RecommendationStrategy = "hybrid" // 别名
